...
import { ProjectListVisibilitySwitch } from '@/components/admin/projects/project-list-visibility-switch';
    ...
    return (
        <>
            ...
            <div className="space-y-6 p-4 md:p-6">
                <AdminPageHeader
                    title="Projects"
                    description="Manage completed work, contracts, and service stories."
                    action={{
                        label: 'Add project',
                        href: projectsRoute.create(),
                    }}
                />
                <AdminTable>
                            ...
                            <tr key={project.id}>
                                ...
                                <td className="px-4 py-3">
                                    <div className="flex justify-end gap-2">
                                        ...
                                        <ConfirmDeleteButton
                                            form={projectsRoute.destroy.form(
                                                project.id,
                                            )}
