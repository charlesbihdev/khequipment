                ...
                <AdminFormShell>
                    <div className="grid gap-5 md:grid-cols-2">
                        ...
                        <Field
                            ...
                            defaultValue={promo?.eyebrow ?? "Today's Deal"}
                            required
                        />
                    </div>
                    ...
                    <div className="grid gap-5 md:grid-cols-2">
                        ...
                        <Field
                            ...
                            defaultValue={
                                promo?.cta_label ?? 'Request on WhatsApp'
                            }
                            required
                        />
                    </div>
                    ...
                    <div className="grid gap-5 md:grid-cols-2">
                        ...
                        <Field
                            ...
                            defaultValue={promo?.ends_at}
                        />
                    </div>

                    <div className="grid gap-5 md:grid-cols-2">
                        <div className="grid gap-2">
                            <RequiredLabel htmlFor="media_type">
                                Media type
                            </RequiredLabel>
                            <select
                                id="media_type"
                                name="media_type"
                                defaultValue={promo?.media_type ?? 'image'}
                                className="h-9 rounded-md border bg-background px-3 text-sm"
                            >
                    ...
                    <div className="flex gap-3">
                        ...
                        <Button asChild variant="outline">
                            <Link href={promos.index()}>Cancel</Link>
                        </Button>
                    </div>
                </AdminFormShell>
            )}
