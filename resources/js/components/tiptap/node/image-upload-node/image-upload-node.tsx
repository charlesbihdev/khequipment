...
const ImageUploadPreview: React.FC<ImageUploadPreviewProps> = ({
  ...
  const previewUrl = useMemo(() => URL.createObjectURL(fileItem.file), [fileItem.file])
    ...
    <div className="tiptap-image-upload-preview">
      ...
      <div className="tiptap-image-upload-preview-content">
        <div className="tiptap-image-upload-file-info">
          <div className="tiptap-image-upload-file-preview">
             <img 
               src={previewUrl} 
               alt={fileItem.file.name} 
               className="tiptap-image-upload-preview-img"
             />
          </div>
